...
latex_documents = [
    (master_doc, 'magnumnp.tex', 'magnum.np Documentation',
     'Florian Bruckner', 'manual'),
]
...
man_pages = [
    (master_doc, 'magnumnp', 'magnum.np Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'magnumnp', 'magnum.np Documentation',
     author, 'magnumnp', 'One line description of project.',
     'Miscellaneous'),
]
