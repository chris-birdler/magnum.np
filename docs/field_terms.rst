...
.. code-block:: python
  ...
  state.write_vtk(demag.h(state), "h.vti")

  # compute energy and print on screen
  print(demag.E(state))

Some field term classes require certain material parameters to be defined. The following documentation offers more detailed information about each class.
