...
The following demo code shows the solution of the muMAG Standard Problem #5 and can be found in the demos directory. Google Colab allows to run magnum.np demos without local installation on CPUs as well as on GPUs (TODO: add link):
