...
Demos integration suite (12 end-to-end problems incl.\ SP4/SP5) & all pass (CPU) \ok \\
...
\item The demo suite was executed on CPU only; on the GPU, coverage comes from
      the unit suite and the benchmarks.
